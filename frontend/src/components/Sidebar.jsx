...
export default function Sidebar() {
    ...
    return (
        <div className="w-1/4 bg-gray-800 text-white">
            ...
            <div className="p-4">
                {/* List of chats */}
                {userList.length == 0 && <h1 className="text-lg font-semibold text-center">No chats found</h1>}
                {
                    userList?.map((user) => (
                        <div className="flex items-center justify-between space-x-4 mb-2 border border-gray-500 cursor-pointer p-2 hover:bg-gray-900 rounded-lg " key={user._id}>
